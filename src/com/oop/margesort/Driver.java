...
public class Driver {
	...
	public static void margeSort(int[] array){
        ...
        int[] rightArr = new int[arrLength - midPointArr]; // right array
         ...
         margeSort(leftArr); // recursion call until leftarray broke into single element
         margeSort(rightArr); // recursion call until rightarray broke into single element
